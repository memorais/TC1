...
A interface gráfica de um navegador possui diversos elementos que são comuns independentes do software que esteja sendo utilizado. Entre estes elementos, pode-se citar: 
\begin{itemize}
