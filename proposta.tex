...
Visando atinigir os objetivos descritos para este trabalho, foi criado o seguinte cronograma de atividades a ser seguido na disciplina de Trabalho de Conclusão I:
\begin{enumerate}
...
\begin{figure}[h]
  \centering
    \includegraphics[scale=1]{scheduler.png}
