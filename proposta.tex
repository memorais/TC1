...
O objetivo deste trabalho não será a aceitação da implementação realizada dentro do código fonte no repositório oficial do Firefox. O objetivo é somente que a renderização nativa seja implementada. O trabalho desenvolvido aqui será entregue à comunidade do Firefox mas sua aplicação não é o alvo principal.
...
Abaixo a ilustração do formato simples com compressão \ingles{lossy}, do formato simples com a compressão \ingles{lossless} e do formato estendido respectivamente.
